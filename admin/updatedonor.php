...
$title = "Jalaria Admin - Update Donor";
                        ...
                        <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nick_name" id="nick_name"
                                       value="<?= $row['nick_name'] ?>" placeholder="Nick Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gov_reg_no" name="gov_reg_no"
                                       value="<?= $row['gov_reg_no'] ?>"
                                       placeholder="Government Registration No">
                            </div>
                            <div class="form-group">
                                <label for="donor_logo">Donor Logo</label>
                                <input type="file" class="dropify" id="donor_logo"
                                       data-default-file="<?= empty($row['logo']) ? '' : URL . 'images/' . $row['logo'] ?>"
                                       name="donor_logo">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="donate_details" id="summernote" placeholder=""><?= $row['donate_details'] ?></textarea>
                            </div>
                            <div class="form-group">
