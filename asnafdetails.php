...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body px-5">
            <div class="col-12 mx-auto" id="printContent" data-title="Asnaf : <?= $name ?>">
                <?php if ($count > 0) { ?>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="col-sm-3">Agency Name :</div>
                    <div class="col-sm-7"> <?= $agancy_name ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="col-sm-3">Agency Id :</div>
                    <div class="col-sm-7"> <?= $agency_id ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-1"></div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Health Condition Critical III Cost Per Month (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Health Condition-Disabled Cost Per Month (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Health Condition-Very Old Cost Per month (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">House Water Bill (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">House Electric Bill (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">House Maintenance Bill (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Total Liquid Asset (RM):</div>
                    <div class="  col-sm-7"><?= $liquid_assets ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Total Fixed Asset (RM):</div>
                ...
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Family Head Relation :</div>
                    <div class="  col-sm-7"><?= $family_head_relation ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-1"></div>
                    <div class="  col-sm-3">Family Head Relation Other :</div>
